...
export default function Login(props: LoginProps) {
  function renderLogin() {
    return (
      <>
        <div className="flex items-center justify-center px-20 py-12 bg-slate-200 opacity-80 rounded-lg mt-12">
  ...
  return (
    <>
      <div className="flex flex-col-2 justify-center">
        <div>{renderLogin()}</div>
        <div className="ml-40 mt-20">{caiu_na_vila_o_peixe_fuzila()}</div>
      </div>
    </>
  );
}
